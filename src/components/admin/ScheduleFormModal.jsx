      ...
      <Form noValidate onSubmit={handleSubmit}>
        ...
        <Modal.Body>
          ...
          <Form.Group className="mb-3" controlId="schedule-assignment">
            ...
            <Form.Select autoFocus isInvalid={Boolean(errors.sport_room_id)} name="sport_room_id" onChange={updateField} value={form.sport_room_id}>
          ...
          <Row>
            <Col md={4}>
              <Form.Group className="mb-3" controlId="schedule-day">
                ...
                <Form.Select isInvalid={Boolean(errors.day_of_week)} name="day_of_week" onChange={updateField} value={form.day_of_week}>
            ...
            <Col md={4}>
              <Form.Group className="mb-3" controlId="schedule-start-time">
                ...
                <Form.Control isInvalid={Boolean(errors.start_time)} name="start_time" onChange={updateField} type="time" value={form.start_time} />
            ...
            <Col md={4}>
              <Form.Group className="mb-3" controlId="schedule-end-time">
                ...
                <Form.Control isInvalid={Boolean(errors.end_time)} name="end_time" onChange={updateField} type="time" value={form.end_time} />
